...
if (isset($_POST['register_button'])) {
    ...
    if (empty($error_array)) {
        ...
        // echo json_encode("INSERT INTO users VALUES ( '$fname','$lname','$username','$em','$password','$date', '$profile_pic', '0', '0', 'no', ',')");
        // exit;

        // echo json_encode("INSERT INTO users('first_name','last_name','username','email','password','signup_date','profile_pic','num_posts','num_likes','user_closed','friend_array') VALUES ( '$fname','$lname','$username','$em','$password','$date', '$profile_pic', '0', '0', 'no', ',')");
        // exit;
