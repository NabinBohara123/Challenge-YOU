...
<head>
    ...
    <link rel="icon" href="https://icon-library.com/images/bull-icon-png/bull-icon-png-19.jpg">
    ...
    <script src="assets/js/Challengers.js"></script>
...
<body>
    ...
    <div class="top_bar">
        <div class="logo">
            <a href="index.php">Challengers</a>
        </div>
