...
<head>
    <title><? echo lang('welcome'); ?> | Challenge You</title>
    <meta charset="UTF-8">
    <!-- <meta name="description" content="Challenge You is a social network platform helps you to post your challenge and stay connected with your community and with who you are interested anytime anywhere."> -->
    <meta name="keywords" content="homepage,main,login,social network,social media,Challenge You,meet,free platform">
    <meta name="author" content="Munaf Aqeel Mahdi">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <?php include "includes/head_imports_main.php";?>
</head>
    <body style="background: purple;" class="login_signup_body">
    <!--============[ Nav bar ]============-->
        <div class="login_signup_navbar">
                <a href="index" class="login_signup_navbarLinks">Challenge You</a>
        ...
        <h3 align="center"><? echo lang('welcome_to'); ?> Challenge You</h3>
        <p align="center" style="color: #999; margin-bottom: 25px;"><? echo lang(''); ?>.</p>
            <div style="display: flex;">
                ...
                <div style="width: 100%;text-align: center;">
                    <img src="imgs/main_icons/challenge.jpeg" alt="Wallstant" style="width: 300px;" />
                </div>
            </div>
        </div>
