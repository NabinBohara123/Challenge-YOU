...
<head>
    ...
    <!--============[ Nav bar ]============-->
        ...
        <!--============[ main contains ]============-->
        <div align="center">
            <div style="background: purple;"  class="login_signup_box2" style="text-align:<? echo lang('textAlign'); ?>">
                <h4 align="center" style="background: #fff;"><? echo lang('login_now'); ?></h4><br/>
                ...
                <p><a href="#" style="color: #fff; font-size: 11px; float: <? echo lang('float2'); ?>;"> <? echo lang('forgot_password'); ?></a></p>
                <button type="submit" class="login_signup_btn1" id="loginFunCode"><? echo lang('login'); ?></button>
                <p id="login_wait" style="margin: 0px;"></p>
            </div>
            <div style="background: blue; border-radius: 3px; max-width: 420px; padding: 15px; margin:auto;margin-top: 15px;color: #fff;" align="center">
                <? echo lang('dont_have_an_account'); ?> <a href="signup"><? echo lang('signup'); ?></a> <? echo lang('for_free'); ?><hr style="margin: 8px; color: #fff;">
                &bull; 
            </div>
        </div>
