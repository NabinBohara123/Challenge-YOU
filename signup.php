...
<head>
    <title><? echo lang('create_new_account'); ?> | Challenge You</title>
    <meta charset="UTF-8">
    ...
    <div align="center">
        ...
        <!--============[ sign up sec ]============-->
            ...
            <p style="font-size: 11px;color: #5d5d5d;margin: 8px 0px; color: #fff">
        ...
        <!--============[ login sec ]============-->
        <div style="background: blue; color:#fff; border-radius: 3px; width: 420px; padding: 15px; margin: 15px;color: #fff;" align="center">
            <? echo lang('already_have_an_account'); ?> <a href="login"><? echo lang('login_now'); ?></a>.<hr style="margin: 8px; color: #fff;">
                &bull; 
        </div>
    </div>
